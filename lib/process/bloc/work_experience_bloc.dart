...
class WorkExperienceBloc {
  ...
  Future<void> addNewWorkExperience(BuildContext context) async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/work-exp/mobile/add");
  ...
  Future<void> updateWorkExperience(
    ...
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/work-exp/mobile/update");
  ...
  Future<void> getAllWorkExperience() async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/work-exp/mobile/all-work-exp/${globals.sitterID}");
  ...
  Future<void> getWorkExperienceByID(String workExperienceID) async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/work-exp/mobile/work-exp/$workExperienceID");
      final response = await http.get(
        url,
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<void> deleteWorkExperience(
    ...
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/work-exp/mobile/remove/$workExperienceID");
