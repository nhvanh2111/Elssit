...
class AchievementBloc {
  ...
  Future<void> addNewAchievement(BuildContext context) async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/achievement/mobile/create");
  ...
  Future<void> getAchievementByID(String achievementID) async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/achievement/common/$achievementID");
  ...
  Future<void> getAllAchievement() async {
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/achievement/common/all/${globals.sitterID}");
      final response = await http.get(
        url,
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<void> updateAchievement(
    ...
    try {
      var url = Uri.parse(
          "https://octopus-app-dtd8l.ondigitalocean.app/api/v1/achievement/mobile/update");
